...
import TokenTable from "../components/DashboardTable";
                ...
                <div className="content">
                    <div className="card-group">
                        ...
                        <div className="card-item sm-card yellow-card br-12">
                            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 48 60" x="0px" y="0px" width={80}>
                    ...
                    <div className="card-group"> 
                        <div className="card-item md-card bg-lightblack br-12">
                            <div className="detail">
                                <span className="wallet-item text-brown">Wallet Address</span>
                                <div>
                                    <span className="text-white" style={{ fontSize: '32px' }}>0x0117851021e5FC9732c337b166A79151F1D78d48</span>
                                </div>
                            </div>
                        </div>
                        <div className="card-item md-card bg-lightblack br-12">
                            <div className="detail">
                                <span className="wallet-item text-brown">Wallet Balance</span>
                                <div>
                                    <span className="text-white">250152</span>
                                </div>  
                            </div>
                        </div>
                    </div>
                    <div className="today-history">
                        <div className="today-condition ">
                            <div className="td-trade bg-lightblack br-12">
                                <span className="text-white">Today Trades</span>
                                <span className="text-white">105</span>
                                <img src={chart_img} alt="" />
                            </div>
                            <div className="td-earning bg-lightblack br-12">
                                <span className="text-white">Today Earning</span>
                                <span className="text-white">105</span>
                                <img src={chart_img} alt="" />
                            </div>
                        </div>
